...
namespace ProgressOS.Core.Services
{
    ...
    {
        private readonly HashAlgorithms _algorithmType;
        private readonly int _iteration;
        private readonly int _saltSize;
        private readonly int _hashSize;

        public PasswordHasherService(HashAlgorithms algorithmType,
        ...
        {
            _algorithmType = HashAlgorithms.BCrypt;
            _iteration = 1000;
            _saltSize = 16;
            _hashSize = 32;
        }
